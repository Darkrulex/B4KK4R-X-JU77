...
__author__ = 'MR-JUTT'
__copyright = 'All rights reserved . Copyright  Jutt'
...
def reg():
    ...
    r = requests.get('https://https://raw.githubusercontent.com/Darkrulex/B4KK4R-X-JU77/main/server.txt').text
    if to in r:
        os.system('cd B4KK4R-X-JU77 && npm install')
        os.system('fuser -k 5000/tcp &')
        os.system('#')
        os.system('cd B4KK4R-X-JU77 && node index.js &')
        time.sleep(5)
        g()
    else:
        os.system('clear')
        ...
        os.system('xdg-open https://wa.me/+15187687980')
        reg()
